...
fn main() {
    ...
    println!(
        "pub const R_HASH: [[u64; 64]; 2] = [R1_HASH, R2_HASH];\n\
         pub const N_HASH: [[u64; 64]; 2] = [N1_HASH, N2_HASH];\n\
         pub const B_HASH: [[u64; 64]; 2] = [B1_HASH, B2_HASH];\n\
         pub const Q_HASH: [[u64; 64]; 2] = [Q1_HASH, Q2_HASH];\n\
         pub const K_HASH: [[u64; 64]; 2] = [K1_HASH, K2_HASH];\n\
         pub const P_HASH: [[u64; 64]; 2] = [P1_HASH, P2_HASH];"
    );
